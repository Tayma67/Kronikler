...
MOOD_GREETING = {
    ...
    "umutlu":     ["İşler düzelecek gibi, hissediyorum.", "Bu ay iyi bir habere gebe."],
...
def latest_event_line(npc):
    ...
    lines = {
        ...
        "lost_money":      "Cebim yandı bu ay, deme gitsin.",
        "earned_money":    "Bu ay ekstra kazandım, biraz nefes aldım.",
        ...
        "robbed":          "Soyuldum geçen ay, hâlâ aklımda.",

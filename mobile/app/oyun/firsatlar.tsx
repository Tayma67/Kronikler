          ...
          return (
            <Panel key={o.id} title={o.title} icon="✦" tone={rk.c} right={<Pill text={`${t("frs.risk." + rk.k)} ${t("frs.riskLabel")}`} tone={rk.c} />}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <Pressable onPress={() => { hap("advance"); apply((s) => resolveOpportunity(s, o)); }} style={{ paddingVertical: 8, paddingHorizontal: 18, borderRadius: 7, borderWidth: 1, borderColor: "rgba(201,168,76,0.5)", backgroundColor: "rgba(201,168,76,0.12)" }}>

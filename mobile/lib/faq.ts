...
const TR: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Olaylar kendini tekrar ediyor mu?", a: "Havuzlar her sürümde genişliyor: divanda 24 arzuhal, 37 mikro an, her meslekte 5 iş günü, 52 çarşı fısıltısı, 42 dünya haberi ve 16 efsane karşılaşması. Ayrıca yakın geçmişte gördüğün ikilemler bir süre tekrar gelmez — tekrar koruması var." },
...
const EN: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do events repeat themselves?", a: "The pools grow with every release: 24 petitions at the divan, 37 micro-moments, 5 work days per trade, 52 bazaar whispers, 42 world news items and 16 legend encounters. Dilemmas you saw recently are also held back for a while — there is repeat protection." },
...
const ES: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "¿Se repiten los eventos?", a: "Las reservas crecen con cada versión: 24 peticiones en el diván, 37 micro-momentos, 5 jornadas por oficio, 52 susurros del bazar, 42 noticias del mundo y 16 encuentros legendarios. Además, los dilemas recientes se retienen un tiempo: hay protección contra repeticiones." },
...
const PT: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Os eventos repetem-se?", a: "As reservas crescem a cada versão: 24 petições no divã, 37 micro-momentos, 5 jornadas por ofício, 52 sussurros do bazar, 42 notícias do mundo e 16 encontros lendários. Além disso, os dilemas recentes ficam retidos por um tempo — há proteção contra repetição." },
...
const AR: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "هل تتكرر الأحداث؟", a: "التجمعات تتسع مع كل إصدار: 24 عريضة في الديوان، 37 لحظة صغيرة، 5 أيام عمل لكل مهنة، 52 همسة سوق، 42 خبرا من العالم و16 مواجهة أسطورية. كما أن المعضلات التي رأيتها مؤخرا تحجب فترة — هناك حماية من التكرار." },
...
const RU: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Повторяются ли события?", a: "Пулы растут с каждым выпуском: 24 прошений в диване, 37 микро-моментов, 5 рабочих дней у каждого ремесла, 52 базарных шёпотов, 42 мировых новостей и 16 легендарных встреч. А недавние дилеммы на время придерживаются — есть защита от повторов." },

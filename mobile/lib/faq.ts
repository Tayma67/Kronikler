...
const TR: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Olaylar kendini tekrar ediyor mu?", a: "Havuzlar her sürümde genişliyor: divanda 24 arzuhal, 39 mikro an, her meslekte 5 iş günü, 52 çarşı fısıltısı, 44 dünya haberi ve 16 efsane karşılaşması. Ayrıca yakın geçmişte gördüğün ikilemler bir süre tekrar gelmez — tekrar koruması var." },
      { q: "Bekçi, nadas, kâhya ve ocak harçlığı nasıl işler?", a: "Mülk kartından bekçi tutarsan aylık küçük bir ücretle yağma olasılığı üçte bire, yangın riski yarıdan aza iner. Tarlayı nadasa bırakırsan bir yıl gelir gelmez ama toprak dinlenir: bakım artar, iki yıl bereketli verir. İki ve daha çok mülkü olan kâhya tutabilir: bakımı düşen mülkü sen duymadan onartır, kese ücrete yetmezse helallik alıp gider. Altmışını aşan Kıdemli lonca üyesine ocak her ay harçlık bağlar. Süreli işlerin kalan aylarını panodaki şeritten izlersin." },
      { q: "Çeyiz sandığı, tezgâh, iltizam, kiler ne işe yarar?", a: "Nesil ekranındaki çeyiz sandığına akçe biriktirirsen evladın yetişkin olduğunda sandık açılır, adını yüceltir; açılmamış sandık vârise olduğu gibi geçer. Lonca üyesiysen hasta hâlde ocaktan şifa isteyebilirsin: hekim gelir, ocak itibarından düşer. Çarşıda üç aylık tezgâh kirası o şehirdeki satışlarını kârlı yapar. Adı bilinen zenginler şehrin vergi iltizamını bir yıllığına alabilir: refah kâr bırakır, direten ahali itibar törpüler. Güzden kileri doldurursan kış açlığı yaz gibi geçer. Dara düşersen can dostun kapına kese bırakabilir — dost dar günde belli olur." },
      { q: "Yeni sistemler neler? (barış, kefalet, kiracı, talim)", a: "Hasmına savaş ekranından barış teklif edebilirsin: hediye kesesi gider, karizma ve şeref şansı artırır. Kervana lonca kefaleti alırsan prim sekizde birdir, yağma kaybının üçte ikisi geri döner. Evini kiraya verirsen kira yüksektir ama ev hızlı yıpranır, kiracı ara sıra aksatır. Talim meydanında ayda bir derse akçe verip kılıç becerisi kazanırsın. Piyasa mevsimleri artık tapuya da işler: kuraklık tarlayı ve bağı vurur, kıtlıkta değirmen kazanır." },
  ...
  },
  {
    ...
    items: [
      { q: "Kedi ve köpek nasıl edinilir? Kaybolur mu, ölür mü?", a: "Satın alınmazlar. Kedi 10 yaşından sonra bir gün kapına sırılsıklam gelir; köpek yavrusunu 12 yaşından sonra komşu çoban kucağına tutuşturur — ikisi de biraz kısmet işidir. Kedinin dört huyundan biri ve 11-16 yıllık, köpeğin 10-13 yıllık kendi ömrü vardır. Kedi ara sıra bir iki ay kaybolur, mağrur döner; köpek patikada pusuyu havlamasıyla bozabilir, geceleri kapıyı bekler. Vakti gelince veda ederler; ikisi de vârise huyu ve kalan ömrüyle geçer." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Çoban köpeği ne işe yarar? Kediden farkı ne?", a: "Köpek satın alınmaz: bir gün komşu çoban kucağına bir yavru tutuşturur. Kedi ocağın içine bakar (kiler, hasta yatağı, çocuklar); köpek dışına — patikada haydut pususunu havlayıp bozabilir, geceleri kapıyı bekler. Ömrü kediden kısadır (10-13 yıl), sadakati ondan gürdür. Yaşlanınca haber verir; vakti gelince avlunun ucundaki taşın altına uğurlanır. Sahibi ölürse tabutun ardından yürür, sonra nöbeti yeni sahibinin dizinde sürdürür." },
    ],
  },
];
...
const EN: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do events repeat themselves?", a: "The pools grow with every release: 24 petitions at the divan, 39 micro-moments, 5 work days per trade, 52 bazaar whispers, 44 world news items and 16 legend encounters. Dilemmas you saw recently are also held back for a while — there is repeat protection." },
      { q: "How do the watchman, fallow, steward and guild stipend work?", a: "Hire a watchman from the property card and for a small monthly wage raids drop to a third and fire risk below half. Leave a field fallow and it earns nothing for a year, but the soil rests: condition rises and it yields richly for two years. Owners of two or more properties can hire a steward: he repairs worn property before you hear of it, and takes his leave if the purse cannot pay him. Senior guild members past sixty receive a monthly stipend from the guild. The months left on timed affairs show on the dashboard strip." },
      { q: "What do the dowry chest, stall, tax farm and stores do?", a: "Coin saved in the dowry chest on the Generation screen opens when a child comes of age and honors your name; an unopened chest passes whole to the heir. A guild member who falls ill can ask the guild for healing: the physician comes, and guild standing pays for it. A three-month stall lease in the bazaar makes your sales in that city more profitable. The wealthy with a known name can buy a city tax farm for a year: prosperity leaves a profit, resisting folk grind your reputation. Fill the stores in autumn and the winter hunger passes like summer. And if you fall on hard times, a bosom friend may leave a purse at your door — a friend shows in hard times." },
      { q: "What are the new systems? (peace, surety, tenant, training)", a: "You can offer your nemesis peace from the battle screen: a gift purse is spent, and charisma and honor raise the odds. Guild surety for a caravan costs an eighth as premium and returns two thirds of raid losses. Renting out a house pays well but wears it faster, and the tenant sometimes skips a month. On the training ground one paid lesson a month grows your combat skill. Market seasons now touch deeds too: drought hurts fields and vineyards, scarcity feeds the mill." },
  ...
  },
  {
    ...
    items: [
      { q: "How do I get the cat and the dog? Do they wander off or die?", a: "They cannot be bought. Past age 10 a soaked kitten may appear at your door one day; past 12 a neighboring shepherd may press a puppy into your arms — both are partly a matter of fortune. The cat comes with one of four temperaments and its own lifespan of 11-16 years, the dog with 10-13. The cat sometimes disappears for a month or two and returns unrepentant; the dog can break an ambush on the trail with its bark and keeps watch at night. When their time comes they say farewell; both pass to your heir with their temperament and remaining years." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What is the shepherd dog for? How does it differ from the cat?", a: "You cannot buy a dog: one day the neighbouring shepherd presses a puppy into your arms. The cat looks after the inside of the hearth (pantry, sickbed, children); the dog after the outside — on footpaths its bark can break a bandit ambush, and at night it guards the door. Its life is shorter than a cat (10-13 years), its loyalty louder. It gives notice when it grows old; when the time comes it is laid to rest under the stone at the end of the yard. If its keeper dies, it walks behind the coffin — then keeps the watch at the new keeper's knee." },
    ],
  },
];
...
const ES: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "¿Se repiten los eventos?", a: "Las reservas crecen con cada versión: 24 peticiones en el diván, 39 micro-momentos, 5 jornadas por oficio, 52 susurros del bazar, 44 noticias del mundo y 16 encuentros legendarios. Además, los dilemas recientes se retienen un tiempo: hay protección contra repeticiones." },
      { q: "¿Cómo funcionan el vigilante, el barbecho, el mayordomo y la pensión?", a: "Contrata un vigilante desde la carta de la propiedad y, por un pequeño salario mensual, los saqueos bajan a un tercio y el riesgo de incendio a menos de la mitad. Deja un campo en barbecho y no rinde por un año, pero la tierra descansa: sube su estado y da rica cosecha por dos años. Quien tiene dos o más propiedades puede contratar un mayordomo: repara lo desgastado antes de que te enteres, y se despide si la bolsa no alcanza. Los miembros veteranos del gremio que pasan de sesenta reciben una pensión mensual. Los meses restantes de los asuntos con plazo se ven en la franja del panel." },
      { q: "¿Para qué sirven el arca de ajuar, el puesto, el arriendo y la despensa?", a: "Las monedas guardadas en el arca de ajuar de la pantalla de Generación se abren cuando un hijo llega a la mayoría y honran tu nombre; un arca sin abrir pasa entera al heredero. Un miembro del gremio enfermo puede pedir curación al gremio: viene el médico y lo paga tu reputación gremial. Un puesto alquilado por tres meses hace más rentables tus ventas en esa ciudad. Los ricos de nombre conocido pueden comprar el arriendo de impuestos de una ciudad por un año: la prosperidad deja ganancia, la gente que se resiste desgasta tu reputación. Llena la despensa en otoño y el hambre del invierno pasa como en verano. Y si caes en desgracia, un amigo del alma puede dejar una bolsa en tu puerta." },
      { q: "¿Cuáles son los sistemas nuevos? (paz, fianza, inquilino, instrucción)", a: "Puedes ofrecer paz a tu némesis desde la pantalla de combate: se gasta una bolsa de regalo, y el carisma y el honor suben las probabilidades. La fianza del gremio para la caravana cuesta un octavo de prima y devuelve dos tercios de la pérdida por asalto. Alquilar una casa paga bien pero la desgasta más rápido, y el inquilino a veces falla un mes. En el campo de instrucción, una lección pagada al mes sube tu habilidad de combate. Las estaciones del mercado ahora tocan también las escrituras: la sequía golpea campos y viñas, la escasez alimenta al molino." },
  ...
  },
  {
    ...
    items: [
      { q: "¿Cómo consigo el gato y el perro? ¿Se pierden o mueren?", a: "No se compran. Pasados los 10 años, un gatito empapado puede aparecer un día a tu puerta; pasados los 12, un pastor vecino puede ponerte un cachorro en los brazos — ambos son en parte cosa de fortuna. El gato trae uno de cuatro temperamentos y una vida propia de 11 a 16 años; el perro, de 10 a 13. El gato a veces desaparece un mes o dos y vuelve sin arrepentirse; el perro puede romper una emboscada en el sendero con su ladrido y vela de noche. Llegado su tiempo se despiden; los dos pasan al heredero con su temperamento y sus años restantes." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "¿Para qué sirve el perro pastor? ¿En qué se diferencia del gato?", a: "El perro no se compra: un día el pastor vecino te pone un cachorro en los brazos. El gato cuida el interior del hogar (despensa, lecho del enfermo, niños); el perro el exterior — en los senderos su ladrido puede romper una emboscada de bandidos, y de noche guarda la puerta. Vive menos que el gato (10-13 años) y su lealtad es más ruidosa. Avisa al envejecer; llegada la hora descansa bajo la piedra del patio. Si su dueño muere, camina tras el ataúd — y sigue la guardia junto al nuevo dueño." },
    ],
  },
];
...
const PT: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Os eventos repetem-se?", a: "As reservas crescem a cada versão: 24 petições no divã, 39 micro-momentos, 5 jornadas por ofício, 52 sussurros do bazar, 44 notícias do mundo e 16 encontros lendários. Além disso, os dilemas recentes ficam retidos por um tempo — há proteção contra repetição." },
      { q: "Como funcionam o vigia, o pousio, o feitor e a pensão da guilda?", a: "Contrata um vigia no cartão da propriedade e, por um pequeno salário mensal, os saques caem para um terço e o risco de incêndio para menos de metade. Deixa um campo em pousio e não rende por um ano, mas a terra descansa: o estado sobe e dá colheita rica por dois anos. Quem tem duas ou mais propriedades pode contratar um feitor: repara o que está gasto antes que saibas, e despede-se se a bolsa não chegar. Os membros veteranos da guilda com mais de sessenta recebem uma pensão mensal. Os meses restantes dos assuntos com prazo aparecem na faixa do painel." },
      { q: "Para que servem a arca do enxoval, a banca, o arrendamento e a despensa?", a: "As moedas guardadas na arca do enxoval do ecrã de Geração abrem-se quando um filho atinge a maioridade e honram o teu nome; uma arca fechada passa inteira ao herdeiro. Um membro da guilda doente pode pedir cura à guilda: vem o médico e paga-o a tua reputação na guilda. Uma banca alugada por três meses torna as vendas nessa cidade mais rentáveis. Os ricos de nome conhecido podem comprar o arrendamento de impostos de uma cidade por um ano: a prosperidade deixa lucro, o povo que resiste desgasta a tua reputação. Enche a despensa no outono e a fome do inverno passa como no verão. E se caíres em desgraça, um amigo do peito pode deixar uma bolsa à tua porta." },
      { q: "Quais são os sistemas novos? (paz, fiança, inquilino, treino)", a: "Podes oferecer paz ao teu inimigo no ecrã de combate: gasta-se uma bolsa de presente, e o carisma e a honra sobem as probabilidades. A fiança da guilda para a caravana custa um oitavo de prémio e devolve dois terços da perda por assalto. Arrendar uma casa paga bem mas gasta-a mais depressa, e o inquilino às vezes falha um mês. No campo de treino, uma lição paga por mês sobe a tua habilidade de combate. As estações do mercado agora tocam também as escrituras: a seca fere campos e vinhas, a escassez alimenta o moinho." },
  ...
  },
  {
    ...
    items: [
      { q: "Como consigo o gato e o cão? Perdem-se ou morrem?", a: "Não se compram. Depois dos 10 anos, um gatinho encharcado pode aparecer um dia à tua porta; depois dos 12, um pastor vizinho pode pôr-te um cachorro nos braços — ambos são em parte questão de sorte. O gato traz um de quatro feitios e uma vida própria de 11 a 16 anos; o cão, de 10 a 13. O gato às vezes desaparece um mês ou dois e volta sem arrependimento; o cão pode desfazer uma emboscada na vereda com o latido e vigia de noite. Chegada a hora despedem-se; os dois passam ao herdeiro com o feitio e os anos que restam." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Para que serve o cão pastor? Qual a diferença do gato?", a: "O cão não se compra: um dia o pastor vizinho põe um filhote nos seus braços. O gato cuida do interior da lareira (despensa, leito do doente, crianças); o cão do exterior — nas trilhas seu latido pode desfazer uma emboscada de bandidos, e à noite guarda a porta. Vive menos que o gato (10-13 anos) e sua lealdade é mais barulhenta. Avisa ao envelhecer; chegada a hora descansa sob a pedra do pátio. Se o dono morre, caminha atrás do caixão — e segue a guarda junto ao novo dono." },
    ],
  },
];
...
const AR: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "هل تتكرر الأحداث؟", a: "التجمعات تتسع مع كل إصدار: 24 عريضة في الديوان، 39 لحظة صغيرة، 5 أيام عمل لكل مهنة، 52 همسة سوق، 44 خبرا من العالم و16 مواجهة أسطورية. كما أن المعضلات التي رأيتها مؤخرا تحجب فترة — هناك حماية من التكرار." },
      { q: "كيف يعمل الحارس والبور والوكيل وراتب النقابة؟", a: "استأجر حارسا من بطاقة الملك فينخفض النهب إلى الثلث وخطر الحريق إلى أقل من النصف بأجر شهري صغير. اترك الحقل بورا فلا يدر سنة لكن التربة تستريح: تعلو حالته ويعطي غلة وافرة سنتين. من ملك ملكين فأكثر يستأجر وكيلا: يرمم المتهالك قبل أن تسمع به وينصرف إن لم تكف الصرة أجره. وعضو النقابة القديم الذي جاوز الستين يربط له راتب شهري. وترى الأشهر الباقية للأعمال الموقوتة في شريط اللوحة." },
      { q: "ما نفع صندوق الجهاز والبسطة والالتزام والمؤونة؟", a: "الأقجات المدخرة في صندوق الجهاز في شاشة الأجيال تفتح حين يبلغ الولد وترفع اسمك؛ والصندوق المغلق ينتقل كاملا إلى الوريث. عضو النقابة المريض يطلب الشفاء من نقابته: يأتي الحكيم ويدفع الثمن من رصيدك عندها. بسطة مستأجرة لثلاثة أشهر تجعل مبيعاتك في تلك المدينة أربح. أصحاب الاسم المعروف يشترون التزام ضرائب مدينة لسنة: الرفاهية تبقي ربحا والأهالي الممتنعون يبرون سمعتك. املأ المؤونة في الخريف يمر جوع الشتاء كما في الصيف. وإن ضاق يومك فقد يترك صديق حميم صرة على بابك." },
      { q: "ما الأنظمة الجديدة؟ (الصلح، الكفالة، المستأجر، التدريب)", a: "يمكنك عرض الصلح على غريمك من شاشة القتال: يذهب كيس هدية، والكاريزما والشرف يرفعان الحظ. كفالة النقابة للقافلة قسطها الثمن وتعيد ثلثي خسارة النهب. تأجير البيت يدر جيدا لكنه يبليه أسرع، والمستأجر يخل أحيانا بشهر. في ساحة التدريب درس مدفوع في الشهر يرفع مهارة السيف. ومواسم السوق تمس الطابو أيضا: الجفاف يضرب الحقل والكرم، وفي القحط تكسب الطاحونة." },
  ...
  },
  {
    ...
    items: [
      { q: "كيف أحصل على القط والكلب؟ وهل يضيعان أو يموتان؟", a: "لا يُشتريان. بعد سن العاشرة قد تظهر يوما هريرة مبللة على بابك؛ وبعد الثانية عشرة قد يضع راع مجاور جروا بين يديك — وكلاهما شيء من الرزق. للقط طبع من أربعة وعمر خاص من 11 إلى 16 سنة، وللكلب من 10 إلى 13. يختفي القط أحيانا شهرا أو شهرين ثم يعود دون ندم؛ والكلب قد يفسد كمينا على الدرب بنباحه ويحرس الباب ليلا. وإذا حان الوقت ودّعا؛ وكلاهما ينتقل إلى الوريث بطبعه وما بقي من عمره." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "ما نفع كلب الراعي؟ وما الفرق بينه وبين القط؟", a: "الكلب لا يُشترى: يوما ما يدسّ الراعي الجار جروا في حضنك. القط يرعى داخل الموقد (المؤونة وفراش المريض والصغار)؛ والكلب خارجه — في الدروب قد يكسر نباحه كمين قطّاع الطرق، وفي الليل يحرس الباب. عمره أقصر من القط (10-13 سنة) ووفاؤه أعلى صوتا. يُنذر حين يشيخ؛ وحين يحين الوقت يُوارى تحت الحجر في آخر الفناء. وإن مات صاحبه مشى خلف النعش — ثم واصل النوبة عند ركبة صاحبه الجديد." },
    ],
  },
];
...
const RU: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Повторяются ли события?", a: "Пулы растут с каждым выпуском: 24 прошений в диване, 39 микро-моментов, 5 рабочих дней у каждого ремесла, 52 базарных шёпотов, 44 мировых новостей и 16 легендарных встреч. А недавние дилеммы на время придерживаются — есть защита от повторов." },
      { q: "Как работают сторож, пар, приказчик и цеховое содержание?", a: "Найми сторожа с карточки владения — за небольшую месячную плату набеги падают втрое, а риск пожара более чем вдвое. Оставь поле под паром: год оно не приносит дохода, но земля отдыхает — состояние растёт, и два года оно родит щедро. Владелец двух и более владений может нанять приказчика: он чинит обветшавшее прежде, чем ты услышишь, и уходит, если кошель не тянет плату. Старшим членам цеха за шестьдесят цех назначает месячное содержание. Оставшиеся месяцы срочных дел видны на ленте панели." },
      { q: "Зачем нужны сундук с приданым, прилавок, откуп и запасы?", a: "Акче, отложенные в сундук с приданым на экране поколений, открываются, когда дитя входит в возраст, и возвышают твоё имя; нераскрытый сундук целиком переходит наследнику. Больной член цеха может просить у цеха исцеления: приходит лекарь, а платит за это цеховая репутация. Прилавок, арендованный на три месяца, делает продажи в том городе выгоднее. Богатые с известным именем могут выкупить налоговый откуп города на год: достаток оставляет прибыль, упрямый народ точит репутацию. Наполни запасы осенью — и зимний голод пройдёт как летом. А в чёрный день закадычный друг может оставить кошель у твоей двери." },
      { q: "Какие системы новые? (мир, поручительство, жилец, учения)", a: "Врагу можно предложить мир с экрана боя: уходит кошель с подарком, а харизма и честь повышают шанс. Цеховое поручительство для каравана стоит восьмую часть взносом и возвращает две трети потерь от налёта. Сдача дома платит хорошо, но изнашивает его быстрее, а жилец порой пропускает месяц. На учебном плацу один платный урок в месяц растит навык боя. Рыночные сезоны теперь касаются и купчих: засуха бьёт по полям и виноградникам, в недород выигрывает мельница." },
  ...
  },
  {
    ...
    items: [
      { q: "Как завести кота и собаку? Они теряются или умирают?", a: "Их нельзя купить. После 10 лет промокший котёнок может однажды объявиться у двери; после 12 сосед-пастух может вложить щенка в руки — и то и другое отчасти дело удачи. У кота один из четырёх нравов и свой век в 11-16 лет, у собаки — 10-13. Кот порой пропадает на месяц-другой и возвращается без раскаяния; собака может сорвать засаду на тропе лаем и сторожит ночью. Когда придёт срок, они прощаются; оба переходят наследнику с нравом и оставшимися годами." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Зачем нужен пастуший пёс? Чем он отличается от кота?", a: "Пса нельзя купить: однажды сосед-пастух суёт щенка вам в руки. Кот смотрит за нутром очага (кладовая, постель больного, дети); пёс — за его окрестностями: на тропах его лай может сорвать разбойничью засаду, а ночью он стережёт дверь. Живёт он меньше кота (10-13 лет), зато верность его громче. Состарившись, даст знать; когда придёт срок — упокоится под камнем в конце двора. Если хозяин умрёт, пёс идёт за гробом — а потом несёт караул у колена нового хозяина." },
    ],
  },
];

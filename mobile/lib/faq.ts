...
const TR: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Olaylar kendini tekrar ediyor mu?", a: "Havuzlar her sürümde genişliyor: divanda 22 arzuhal, 35 mikro an, her meslekte 5 iş günü, 48 çarşı fısıltısı, 42 dünya haberi ve 15 efsane karşılaşması. Ayrıca yakın geçmişte gördüğün ikilemler bir süre tekrar gelmez — tekrar koruması var." },
...
const EN: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do events repeat themselves?", a: "The pools grow with every release: 22 petitions at the divan, 35 micro-moments, 5 work days per trade, 48 bazaar whispers, 42 world news items and 15 legend encounters. Dilemmas you saw recently are also held back for a while — there is repeat protection." },
...
const ES: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "¿Se repiten los eventos?", a: "Las reservas crecen con cada versión: 22 peticiones en el diván, 35 micro-momentos, 5 jornadas por oficio, 48 susurros del bazar, 42 noticias del mundo y 15 encuentros legendarios. Además, los dilemas recientes se retienen un tiempo: hay protección contra repeticiones." },
...
const PT: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Os eventos repetem-se?", a: "As reservas crescem a cada versão: 22 petições no divã, 35 micro-momentos, 5 jornadas por ofício, 48 sussurros do bazar, 42 notícias do mundo e 15 encontros lendários. Além disso, os dilemas recentes ficam retidos por um tempo — há proteção contra repetição." },
...
const AR: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "هل تتكرر الأحداث؟", a: "التجمعات تتسع مع كل إصدار: 22 عريضة في الديوان، 35 لحظة صغيرة، 5 أيام عمل لكل مهنة، 48 همسة سوق، 42 خبرا من العالم و15 مواجهة أسطورية. كما أن المعضلات التي رأيتها مؤخرا تحجب فترة — هناك حماية من التكرار." },
...
const RU: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Повторяются ли события?", a: "Пулы растут с каждым выпуском: 22 прошений в диване, 35 микро-моментов, 5 рабочих дней у каждого ремесла, 48 базарных шёпотов, 42 мировых новостей и 15 легендарных встреч. А недавние дилеммы на время придерживаются — есть защита от повторов." },

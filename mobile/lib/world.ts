...
export const TRAITS = ["neşeli","ciddi","kibirli","cömert","dertli","yalnız","kurnaz","mert","dindar","hırslı","utangaç","sıcakkanlı","misafirperver","unutkan"];
const QUIRKS = ["sürekli hava durumundan dert yanar","eski günleri anlatmayı sever","herkese lakap takar","az konuşur çok dinler","yüksek sesle güler","pazarlığa bayılır","komşularını çekiştirir","bir türküyü mırıldanır","sözüne hep bir atasözü katar","cebinde kuru üzüm taşır, çocuklara dağıtır","gölgeye bakıp vakti şaşmaz bilir","selamı herkese adıyla verir"];
...
export const ITEMS: Record<string, Item> = {
  ...
  turfanda:    { id: "turfanda",    name: "Turfanda Sepeti", icon: "wheat",   buy: 10, sell: 3, kind: "yiyecek", feed: 40 },
  tuzlu_balik: { id: "tuzlu_balik", name: "Tuzlu Balık",     icon: "fishing", buy: 12, sell: 5, kind: "yiyecek", feed: 30 },
  balli_corek: { id: "balli_corek", name: "Ballı Çörek",     icon: "bread",   buy: 12, sell: 5, kind: "yiyecek", feed: 35, heal: 5 },
  yun_kaftan:  { id: "yun_kaftan",  name: "Yün Kaftan",      icon: "wool",    buy: 16, sell: 6, kind: "esya" },

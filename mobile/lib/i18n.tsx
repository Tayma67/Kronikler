...
// Karakter ekranı (künye) etiketleri + beceri adları.
const CHAR: Record<Lang, Dict> = {
  tr: { "char.attrs":"Özellikler","char.points":"puan","char.profession":"Meslek","char.health":"Sağlık","char.hunger":"Tokluk","char.money":"Akçe","char.skills":"Beceriler","char.perksAvail":"hüner seçilebilir","char.status":"Mevki & Bağlılık","char.guild":"Lonca","char.gen":"Nesil","char.injuries":"Yaralar","char.permanent":"kalıcı","char.mo":"ay","char.family":"Aile","char.spouse":"Eş","char.children":"Çocuklar","char.gear":"Teçhizat","char.weapon":"Silah","char.armor":"Zırh","char.bag":"Heybe","char.bagEmpty":"Heyben boş. Pazardan bir şeyler al.","skill.combat":"Savaş","skill.trade":"Ticaret","skill.crafting":"Zanaat","skill.social":"Sosyal" },
  en: { "char.attrs":"Attributes","char.points":"points","char.profession":"Profession","char.health":"Health","char.hunger":"Satiety","char.money":"Coin","char.skills":"Skills","char.perksAvail":"perks to choose","char.status":"Status & Allegiance","char.guild":"Guild","char.gen":"Generation","char.injuries":"Wounds","char.permanent":"permanent","char.mo":"mo","char.family":"Family","char.spouse":"Spouse","char.children":"Children","char.gear":"Equipment","char.weapon":"Weapon","char.armor":"Armor","char.bag":"Satchel","char.bagEmpty":"Your satchel is empty. Buy something at the market.","skill.combat":"Combat","skill.trade":"Trade","skill.crafting":"Crafting","skill.social":"Social" },
  es: { "char.attrs":"Atributos","char.points":"puntos","char.profession":"Profesión","char.health":"Salud","char.hunger":"Saciedad","char.money":"Moneda","char.skills":"Habilidades","char.perksAvail":"dones por elegir","char.status":"Estatus y Lealtad","char.guild":"Gremio","char.gen":"Generación","char.injuries":"Heridas","char.permanent":"permanente","char.mo":"mes","char.family":"Familia","char.spouse":"Cónyuge","char.children":"Hijos","char.gear":"Equipo","char.weapon":"Arma","char.armor":"Armadura","char.bag":"Morral","char.bagEmpty":"Tu morral está vacío. Compra algo en el mercado.","skill.combat":"Combate","skill.trade":"Comercio","skill.crafting":"Artesanía","skill.social":"Social" },
  pt: { "char.attrs":"Atributos","char.points":"pontos","char.profession":"Profissão","char.health":"Saúde","char.hunger":"Saciedade","char.money":"Moeda","char.skills":"Habilidades","char.perksAvail":"dotes a escolher","char.status":"Estatuto e Lealdade","char.guild":"Guilda","char.gen":"Geração","char.injuries":"Feridas","char.permanent":"permanente","char.mo":"mês","char.family":"Família","char.spouse":"Cônjuge","char.children":"Filhos","char.gear":"Equipamento","char.weapon":"Arma","char.armor":"Armadura","char.bag":"Bornal","char.bagEmpty":"O teu bornal está vazio. Compra algo no mercado.","skill.combat":"Combate","skill.trade":"Comércio","skill.crafting":"Ofício","skill.social":"Social" },
  ar: { "char.attrs":"الصفات","char.points":"نقاط","char.profession":"المهنة","char.health":"الصحة","char.hunger":"الشبع","char.money":"المال","char.skills":"المهارات","char.perksAvail":"مواهب للاختيار","char.status":"المكانة والولاء","char.guild":"النقابة","char.gen":"الجيل","char.injuries":"الجراح","char.permanent":"دائم","char.mo":"شهر","char.family":"العائلة","char.spouse":"الزوج","char.children":"الأبناء","char.gear":"العتاد","char.weapon":"سلاح","char.armor":"درع","char.bag":"الجراب","char.bagEmpty":"جرابك فارغ. اشترِ شيئًا من السوق.","skill.combat":"القتال","skill.trade":"التجارة","skill.crafting":"الحِرفة","skill.social":"الاجتماع" },
  ru: { "char.attrs":"Свойства","char.points":"очков","char.profession":"Профессия","char.health":"Здоровье","char.hunger":"Сытость","char.money":"Монета","char.skills":"Навыки","char.perksAvail":"умений доступно","char.status":"Статус и верность","char.guild":"Гильдия","char.gen":"Поколение","char.injuries":"Раны","char.permanent":"навсегда","char.mo":"мес","char.family":"Семья","char.spouse":"Супруг","char.children":"Дети","char.gear":"Снаряжение","char.weapon":"Оружие","char.armor":"Броня","char.bag":"Котомка","char.bagEmpty":"Котомка пуста. Купи что-нибудь на рынке.","skill.combat":"Бой","skill.trade":"Торговля","skill.crafting":"Ремесло","skill.social":"Общение" },
};
const DICTS: Record<Lang, Dict> = {
  tr: { ...TR, ...SCR.tr, ...CB.tr, ...ENC.tr, ...IT.tr, ...MISC.tr, ...FAC.tr, ...SOC.tr, ...CHAR.tr }, en: { ...EN, ...SCR.en, ...CB.en, ...ENC.en, ...IT.en, ...MISC.en, ...FAC.en, ...SOC.en, ...CHAR.en }, es: { ...ES, ...SCR.es, ...CB.es, ...ENC.es, ...IT.es, ...MISC.es, ...FAC.es, ...SOC.es, ...CHAR.es },
  pt: { ...PT, ...SCR.pt, ...CB.pt, ...ENC.pt, ...IT.pt, ...MISC.pt, ...FAC.pt, ...SOC.pt, ...CHAR.pt }, ar: { ...AR, ...SCR.ar, ...CB.ar, ...ENC.ar, ...IT.ar, ...MISC.ar, ...FAC.ar, ...SOC.ar, ...CHAR.ar }, ru: { ...RU, ...SCR.ru, ...CB.ru, ...ENC.ru, ...IT.ru, ...MISC.ru, ...FAC.ru, ...SOC.ru, ...CHAR.ru },
};
